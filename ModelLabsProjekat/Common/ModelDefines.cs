...
namespace FTN.Common
{
	...
	public enum ModelCode : long
	{
        ...
        ASSETFUNCTION_CONFIGID              = 0x1100000000000107,
        ASSETFUNCTION_FIRMWAREID              = 0x1100000000000207,
        ASSETFUNCTION_HARDWAREID              = 0x1100000000000307,
        ASSETFUNCTION_PASSWORD                  = 0x1100000000000407,
        ASSETFUNCTION_PROGRAMID             = 0x1100000000000507,

        ORGANISATIONROLE                    = 0x1200000000000000,

        ASSET                               = 0x1300000000010000,
        ASSET_CRITICAL                      = 0x1300000000000101,
        ASSET_INITIALCONDITION              = 0x1300000000000207,
        ASSET_INITIALLOSSOFLIFE             = 0x1300000000000305,
        ASSET_LOTNUMBER                     = 0x1300000000000407,
        ASSET_PURCHASEPRICE                 = 0x1300000000000505,
        ASSET_SERIALNUMBER                  = 0x1300000000000607,
        ASSET_TYPE                          = 0x1300000000000707,
        ASSET_UTCNUMBER                     = 0x1300000000000807,
        ASSET_ORGANISATIONROLE              = 0x1300000000000909,
        ASSET_ASSETINFO                     = 0x1300000000001009,

        ASSETINFO                           = 0x1400000000040000,
        ASSETINFO_ASSETMODEL                = 0x1400000000000109,
        ASSETINFO_ASSETS                    = 0x1400000000000219,

        ASSETMODEL                          = 0x1500000000000000,
        ASSETMODEL_ASSETINFOS               = 0x1500000000000119,

        SEAL                                = 0x1600000000050000,
        SEAL_APPLIEDTIME                    = 0x1600000000000108,
        SEAL_CONDITION                      = 0x160000000000020A,
        SEAL_KIND                           = 0x160000000000030A,
        SEAL_SEALNUMBER                     = 0x1600000000000407,
        ...
        MANUFACTURER_PRODUCTASSETS           = 0x1220000000000119,

        PRODUCTASSETMODEL                   = 0x1510000000070000,
        PRODUCTASSETMODEL_CSTANDARDKIND            = 0x151000000000010A,
        PRODUCTASSETMODEL_MODELNUMBER       = 0x1510000000000207,
        PRODUCTASSETMODEL_MODELVERSION      = 0x1510000000000307,
        PRODUCTASSETMODEL_USAGEKIND         = 0x151000000000040A,
        PRODUCTASSETMODEL_WEIGHTTOTAL       = 0x1510000000000505,
        PRODUCTASSETMODEL_MANUFACTURER      = 0x1510000000000609,
