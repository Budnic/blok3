...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.PRODUCTASSETMODEL_USAGEKIND, typeof(AssetModelUsageKind));
			property2enumType.Add(ModelCode.PRODUCTASSETMODEL_CSTANDARDKIND, typeof(CorporateStandardKind));														
		}
